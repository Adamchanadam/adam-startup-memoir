...
2015 年，他開始建立 GRWTH，嘗試把學校、家庭、學生、社區機構與服務供應商接成一個成長生態。當中的 GRWTH Pay 於 2019 年獲香港資訊及通訊科技獎智慧生活獎金獎，GRWTH VOD 雲課堂系統於 2020 年獲香港電腦學會 Outstanding Education Award。這本回憶錄值得被讀，不是因為它展示一間公司的成功，而是因為它記下一位香港教育科技創業者如何把設計、產品、學校營運、團隊、商業模式與生命代價放在同一條路上，最後學會放手和重新整理自己。

## 書封與內頁預覽

不一定每位讀者都會即時下載 EPUB 或 PDF，所以這裡先放出書封與章節開場頁，讓讀者先看見這本書的語氣、節奏與內容方向。

![《一個教育科技創業者的成長課》書封面](assets/book-cover.png)

| 序章 | 第三章 | 第七章 |
|---|---|---|
| ![序章〈放手，是為了把自己重新活出來〉章節頁預覽](assets/preview-prologue.jpg) | ![第三章〈把成長做成一個生態圈〉章節頁預覽](assets/preview-ecosystem.jpg) | ![第七章〈身體比我更早知道答案〉章節頁預覽](assets/preview-body-warning.jpg) |
...
正式上 GitHub Pages 前，請先確認公開網址是否為：

`https://adamchanadam.github.io/adam-startup-memoir/`

若 repository 名稱或 GitHub Pages URL 不同，需全局替換此網址。
